...
export function OnboardingRegister({ onComplete, onboardingAnswers }: OnboardingRegisterProps) {
    ...
    <div className="max-w-md mx-auto">
      ...
      <Card className="border-primary/20 bg-background/80 backdrop-blur-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">Let's Get Started</CardTitle>
          <CardDescription className="text-center">Tell us a bit about yourself to save your progress</CardDescription>
        </CardHeader>
