...
const IndividualRegister: React.FC = () => {
      ...
      <div className="container max-w-md z-10">
        ...
        <Card className="border-primary/20 bg-background/80 backdrop-blur-md">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Start your journey to find the perfect job match</CardDescription>
          </CardHeader>
          <CardContent>
            <Button
              variant="outline"
            ...
            <div className="mt-4 text-center text-sm">
              ...
              <a href="/individual-login" className="text-primary hover:underline">
                Sign in
              </a>
            </div>
          </CardContent>
          <CardFooter className="flex justify-center border-t pt-6">
            <a href="/company/register" className="text-sm text-muted-foreground hover:text-primary">
              Hiring? Register as a company
            </a>
          </CardFooter>
        </Card>
      </div>
